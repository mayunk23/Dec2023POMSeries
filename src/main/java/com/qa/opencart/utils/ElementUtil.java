...
public class ElementUtil {
	...
	// Without Select class, select the dropDown
	...
	public void doSearch(By searchLocator, By searchSuggestions, String searchKey, String value)
		...
		List<WebElement> sugglist = getElements(searchLocator);
	 ...
	 */
	public void selectChoice(By dropDownlocator, By choicesLocator, String... value) throws InterruptedException {

		driver.findElement(dropDownlocator).click();

		Thread.sleep(2000);
		List<WebElement> choices = driver.findElements(choicesLocator);
